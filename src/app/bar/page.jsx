  ...
  return (
    <>
      <div className="z-50 shadow-custom-tall">
        <div className="z-10 justify-center hidden w-full py-2 text-center lg:flex fle text-secondary-normal ">
          136 BROADWAY, BROOKLYN, NY 11249 718-218-7572
        </div>
      </div>
      <Navbar />
      <div className="flex items-center justify-center px-6 mt-20 tracking-widest text-center sm:px-10 lg:px-20 text-secondary-normal">
