    ...
    <>
      ...
      <div className="flex justify-center mx-10 mt-20 lg:mx-28">
        <div className="flex flex-col justify-center text-center">
          <div className="grid justify-center grid-cols-3 gap-4 text-center lg:gap-10 sm:grid-cols-3 lg:grid-cols-5">
            {categories.map((item, index) => (
              <div
                key={index}
                onClick={() => getProduct(item.title)}
                className="text-secondary-normal text-[10px] sm:text-sm lg:text-base  items-center w-20 lg:w-44 border-[1px] p-1 sm:p-2 border-secondary-normal text-center rounded-md hover:bg-secondary-normal hover:text-primary font-semibold cursor-pointer"
              >
                {item.title}
              </div>
            ))}
      ...
      <div className="flex flex-col items-center p-3 m-5 sm:p-7 sm:m-10 lg:p-10 lg:m-20 bg-secondary-normal">
        <div className="p-[1px] w-full border-2 border-primary">
